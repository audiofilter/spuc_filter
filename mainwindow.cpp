...
QCPGraph* MainWindow::GetPtr() {
  //  std::cout << " shape was = " << shape << "\n";
	...
	//	else if (shape=="Variable Allpass")	return(VariableAllpass_on);
	else if (shape=="Elliptic") return(Elliptic_on);
	else if (shape=="Maxflat FIR") return(MaxflatFIR_on);
	//	else if (shape=="Gaussian FIR") return(GaussianFIR_on);
	...
	//	else if (shape=="Shelf") return(Shelf_on);
	//	else if (shape=="VariableShelf")	return(VariableShelf_on);
	else if (shape=="Root Raised Cosine") return(RootRaisedCosine_on);
	//	else if (shape=="CIC") return(Cic_on);
	//	else if (shape=="Comb") return(Comb_on);
	//	else if (shape=="CombAllpass") return(CombAllpass_on);
	//    else if (shape=="None") return(None_on);
	//    else if (shape=="50 Hertz Notch") return(Notch50_on);
